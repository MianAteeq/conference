...
@endif
                        ...
                        <h3>Personal Information</h3>
                          <div class="form-group">
                            ...
                            <div style="display: flex; gap: 10px;">
                                <select name="prefix" id="prefix" class="form-control" style="max-width:120px;" required>
                                ...
                                <input type="text" name="first_name" id="name" class="form-control" placeholder="Enter Your First Name" required>
                            </div>
                        </div>
    ...
    <small id="phone-error" style="color:red;display:none;">Please enter a valid phone number.</small>
</div>
                        ...
                        <div class="form-group"><label>City</label>
                            <input type="text" name="city" value="{{old('city')}}" placeholder="Enter Your City" class="form-control">
                        </div>
                    ...
                    <div class="step-content" id="step2">
                        ...
                        <div class="form-group"><label>Qualification</label>
                            <input type="text" name="qualification" required
                                placeholder="Enter Your Qualification" value="{{old('qualification')}}" class="form-control">
                        </div>
    ...
    <select name="institute_name" class="form-control" required>
        ...
        <option {{ old('institute_name') == 'Dental Section, Bolan Medical College' ? 'selected' : '' }}>Dental Section, Bolan Medical College</option>
        <option {{ old('institute_name') == 'Bacha Khan Dental College' ? 'selected' : '' }}>Bacha Khan Dental College</option>
        <option {{ old('institute_name') == 'Dental College, Ayub Medical College' ? 'selected' : '' }}>Dental College, Ayub Medical College</option>
        <option {{ old('institute_name') == 'Khyber College of Dentistry' ? 'selected' : '' }}>Khyber College of Dentistry</option>
        <option {{ old('institute_name') == 'KMU Institute of Dental Sciences / KIDS' ? 'selected' : '' }}>KMU Institute of Dental Sciences / KIDS</option>
        <option {{ old('institute_name') == 'Saidu Dental College' ? 'selected' : '' }}>Saidu Dental College</option>
        <option {{ old('institute_name') == 'de’Montmorency College of Dentistry' ? 'selected' : '' }}>de’Montmorency College of Dentistry</option>
        <option {{ old('institute_name') == 'Dental Section, Army Medical College' ? 'selected' : '' }}>Dental Section, Army Medical College</option>
        <option {{ old('institute_name') == 'Dental Section, Punjab Medical College' ? 'selected' : '' }}>Dental Section, Punjab Medical College</option>
        <option {{ old('institute_name') == 'Institute of Dentistry, Nishtar Medical College' ? 'selected' : '' }}>Institute of Dentistry, Nishtar Medical College</option>
        <option {{ old('institute_name') == 'School of Dentistry, Shaheed Zulfiqar Ali Bhutto Medical University' ? 'selected' : '' }}>School of Dentistry, Shaheed Zulfiqar Ali Bhutto Medical University</option>
        <option {{ old('institute_name') == 'Bibi Aseefa Dental College' ? 'selected' : '' }}>Bibi Aseefa Dental College</option>
        <option {{ old('institute_name') == 'Dental Department, Karachi Medical & Dental College' ? 'selected' : '' }}>Dental Department, Karachi Medical & Dental College</option>
        <option {{ old('institute_name') == 'Dr. Ishratul Ebad Institute of Oral Health Sciences' ? 'selected' : '' }}>Dr. Ishratul Ebad Institute of Oral Health Sciences</option>
        <option {{ old('institute_name') == 'Faculty of Dentistry, Liaquat University of Medical & Health Sciences' ? 'selected' : '' }}>Faculty of Dentistry, Liaquat University of Medical & Health Sciences</option>
        <option {{ old('institute_name') == 'Sindh Institute of Oral Health Sciences / JSMU' ? 'selected' : '' }}>Sindh Institute of Oral Health Sciences / JSMU</option>
        <option {{ old('institute_name') == 'Dow Dental College' ? 'selected' : '' }}>Dow Dental College</option>
        <option {{ old('institute_name') == 'Dental College, Islamabad Medical & Dental College' ? 'selected' : '' }}>Dental College, Islamabad Medical & Dental College</option>
        <option {{ old('institute_name') == 'Dental College, Rawal Institute of Health Sciences' ? 'selected' : '' }}>Dental College, Rawal Institute of Health Sciences</option>
        <option {{ old('institute_name') == 'Foundation University College of Dentistry' ? 'selected' : '' }}>Foundation University College of Dentistry</option>
        <option {{ old('institute_name') == 'HBS Dental College' ? 'selected' : '' }}>HBS Dental College</option>
        <option {{ old('institute_name') == 'Islamic International Dental College' ? 'selected' : '' }}>Islamic International Dental College</option>
        <option {{ old('institute_name') == 'Shifa College of Dentistry' ? 'selected' : '' }}>Shifa College of Dentistry</option>
        <option {{ old('institute_name') == 'Dental Section, Women Medical College, Abbottabad' ? 'selected' : '' }}>Dental Section, Women Medical College, Abbottabad</option>
        <option {{ old('institute_name') == 'Dental Section, Abbottabad International Medical College' ? 'selected' : '' }}>Dental Section, Abbottabad International Medical College</option>
        <option {{ old('institute_name') == 'Dental Section, Frontier Medical College, Abbottabad' ? 'selected' : '' }}>Dental Section, Frontier Medical College, Abbottabad</option>
        <option {{ old('institute_name') == 'Rehman College of Dentistry, Peshawar' ? 'selected' : '' }}>Rehman College of Dentistry, Peshawar</option>
        <option {{ old('institute_name') == 'Peshawar Dental College' ? 'selected' : '' }}>Peshawar Dental College</option>
        <option {{ old('institute_name') == 'Sardar Begum Dental College, Peshawar' ? 'selected' : '' }}>Sardar Begum Dental College, Peshawar</option>
        <option {{ old('institute_name') == 'Avicenna Dental College, Lahore' ? 'selected' : '' }}>Avicenna Dental College, Lahore</option>
        <option {{ old('institute_name') == 'Naheed Dental College, Lahore' ? 'selected' : '' }}>Naheed Dental College, Lahore</option>
        <option {{ old('institute_name') == 'CMH Institute of Medical Sciences / CIMS Dental College, Multan' ? 'selected' : '' }}>CMH Institute of Medical Sciences / CIMS Dental College, Multan</option>
        <option {{ old('institute_name') == 'Bakhtawar Amin Medical & Dental College (Dental Section), Multan' ? 'selected' : '' }}>Bakhtawar Amin Medical & Dental College (Dental Section), Multan</option>
        <option {{ old('institute_name') == 'College of Dentistry, Sharif Medical & Dental College, Lahore' ? 'selected' : '' }}>College of Dentistry, Sharif Medical & Dental College, Lahore</option>
        <option {{ old('institute_name') == 'Dental College, University Medical & Dental College, Faisalabad' ? 'selected' : '' }}>Dental College, University Medical & Dental College, Faisalabad</option>
        <option {{ old('institute_name') == 'Dental College, FMH College of Medicine & Dentistry, Lahore' ? 'selected' : '' }}>Dental College, FMH College of Medicine & Dentistry, Lahore</option>
        <option {{ old('institute_name') == 'Dental College, Akhtar Saeed Medical & Dental College, Lahore' ? 'selected' : '' }}>Dental College, Akhtar Saeed Medical & Dental College, Lahore</option>
        <option {{ old('institute_name') == 'Dental Section, Multan Medical & Dental College' ? 'selected' : '' }}>Dental Section, Multan Medical & Dental College</option>
        <option {{ old('institute_name') == 'Dental College, University College of Medicine & Dentistry, Lahore' ? 'selected' : '' }}>Dental College, University College of Medicine & Dentistry, Lahore</option>
        <option {{ old('institute_name') == 'Dental College, HITEC Institute of Medical Sciences, Taxila Cantt' ? 'selected' : '' }}>Dental College, HITEC Institute of Medical Sciences, Taxila Cantt</option>
        <option {{ old('institute_name') == 'Faryal Dental College, Sheikhupura' ? 'selected' : '' }}>Faryal Dental College, Sheikhupura</option>
        <option {{ old('institute_name') == 'Institute of Dentistry, CMH Lahore Medical College' ? 'selected' : '' }}>Institute of Dentistry, CMH Lahore Medical College</option>
        <option {{ old('institute_name') == 'Islam Dental College, Sialkot' ? 'selected' : '' }}>Islam Dental College, Sialkot</option>
        <option {{ old('institute_name') == 'Margalla College of Dentistry, Rawalpindi' ? 'selected' : '' }}>Margalla College of Dentistry, Rawalpindi</option>
        <option {{ old('institute_name') == 'Rashid Latif Dental College, Lahore' ? 'selected' : '' }}>Rashid Latif Dental College, Lahore</option>
        <option {{ old('institute_name') == 'Shahida Islam Dental College, Lodhran' ? 'selected' : '' }}>Shahida Islam Dental College, Lodhran</option>
        <option {{ old('institute_name') == 'Watim Dental College, Rawalpindi' ? 'selected' : '' }}>Watim Dental College, Rawalpindi</option>
        <option {{ old('institute_name') == 'Lahore Medical & Dental College (Dental Section)' ? 'selected' : '' }}>Lahore Medical & Dental College (Dental Section)</option>
        <option {{ old('institute_name') == 'Dental Section, Jinnah Medical & Dental College, Karachi' ? 'selected' : '' }}>Dental Section, Jinnah Medical & Dental College, Karachi</option>
        <option {{ old('institute_name') == 'Isra Dental College, Hyderabad' ? 'selected' : '' }}>Isra Dental College, Hyderabad</option>
        <option {{ old('institute_name') == 'Altamash Institute of Dental Medicine, Karachi' ? 'selected' : '' }}>Altamash Institute of Dental Medicine, Karachi</option>
        <option {{ old('institute_name') == 'Baqai Dental College, Karachi' ? 'selected' : '' }}>Baqai Dental College, Karachi</option>
        <option {{ old('institute_name') == 'Bhittai Dental & Medical College, Mirpurkhas' ? 'selected' : '' }}>Bhittai Dental & Medical College, Mirpurkhas</option>
        <option {{ old('institute_name') == 'Dental College, Sir Syed College of Medical Sciences for Girls, Karachi' ? 'selected' : '' }}>Dental College, Sir Syed College of Medical Sciences for Girls, Karachi</option>
        <option {{ old('institute_name') == 'Dental College, Bahria University Medical & Dental College, Karachi' ? 'selected' : '' }}>Dental College, Bahria University Medical & Dental College, Karachi</option>
        <option {{ old('institute_name') == 'Dental Section, Liaquat College of Medicine & Dentistry, Karachi' ? 'selected' : '' }}>Dental Section, Liaquat College of Medicine & Dentistry, Karachi</option>
        <option {{ old('institute_name') == 'Dental Section, Hamdard College of Medicine & Dentistry, Karachi' ? 'selected' : '' }}>Dental Section, Hamdard College of Medicine & Dentistry, Karachi</option>
        <option {{ old('institute_name') == 'Fatima Jinnah Dental College, Karachi' ? 'selected' : '' }}>Fatima Jinnah Dental College, Karachi</option>
        <option {{ old('institute_name') == 'Dental College, Mirpurkhas' ? 'selected' : '' }}>Dental College, Mirpurkhas</option>
        <option {{ old('institute_name') == 'Ziauddin Dental College, Karachi' ? 'selected' : '' }}>Ziauddin Dental College, Karachi</option>
    ...
    <input type="text" id="promoCode" name="promoCode" class="form-control" placeholder="Enter Promo Code" onkeyup="updateSummary()">
            ...
            checkEmailExists(email)
                .then((exists) => {
                    if (exists) {
                        ...
                        $('#email').css('border-color', '#ccc');
                        // ✅ Only proceed when all validations passed
                       nextStep(2);
                    }
                })
                .catch((err) => {
                    console.error(err);
                    showError(emailField, 'Error checking email.');
                });
        }, 300);
    } else {
