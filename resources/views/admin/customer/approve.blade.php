...
<section id="configuration">
    ...
    @endif
                                        ...
                                        <td>
                                            ...
                                            Payment Approved
                                            @else
                                            <a href="{{route('admin.approve.candidates.payment',$customer['id'])}}" class="btn btn-success">Approve</a>
                                        ...
                                        @if(auth()->user()->role=="admin")
                                        <td>
                                            <a href="{{route('admin.send.download',$customer['id'])}}" class="primary" style="margin-left: 20px;"><i class="la la-download"></i></a>
